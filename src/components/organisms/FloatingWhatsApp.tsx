...
export default function FloatingWhatsApp() {
  ...
  const message = 'Halo, saya ingin konsultasi mengenai layanan IT Digital Company Group';
  ...
  return (
    <motion.button
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-green-500 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center group"
